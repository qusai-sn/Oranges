    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TodayOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TodayOrders_Meals_MealsId",
                        column: x => x.MealsId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TodayOrders_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodayOrders_MealsId",
                table: "TodayOrders",
                column: "MealsId");

            migrationBuilder.CreateIndex(
                name: "IX_TodayOrders_UsersId",
                table: "TodayOrders",
                column: "UsersId");
        }
